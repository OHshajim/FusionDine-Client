        ...
        <div className=" flex flex-col items-center justify-center">
            ...
            {/* <p className="text-red-600 font-bold mt-5">{error.error.message}</p> */}
            {
                error.status === 404 && <div className=" flex flex-col items-center ">
                    <Link to={'/'}><button className="btn  my-2 font-bold btn-outline text-lg hover:bg-black text-orange-400 border-orange-400"><IoMdArrowRoundBack />Back to Home</button></Link>
                </div >
            }
        </div >
    );
