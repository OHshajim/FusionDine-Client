        ...
        <div>
            <div className=' my-20 max-w-[1600px] mx-auto '>
                ...
                >
                    ...
                    <SwiperSlide>
                        <div
                            className=' border rounded-lg border-b-4 border-r-4 border-double p-10 group hover:border-orange-500  duration-500'
                        >
                            <div className=' flex flex-col items-center justify-center space-y-3'>
                                ...
                                <p className='text-sm text-center'>Plan your dream wedding with <span className="font-bold group-hover:text-orange-500">FusionDine</span>! From start to finish, we will make every moment feel cozy and special.</p>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                    ...
                    <SwiperSlide>
                        <div
                            className=' border rounded-md border-b-4 border-r-4 border-double p-10 group hover:border-orange-500  duration-500'
                        >
                            <div className=' flex flex-col items-center justify-center space-y-3'>
                    ...
                    <SwiperSlide>
                        ...
                        >
                            <div className=' flex flex-col items-center justify-center space-y-3'>
                                ...
                                <p className='text-sm text-center'>Let <span className="font-bold group-hover:text-orange-500">FusionDine</span> cater your event! We will bring tasty food and friendly service to make your gathering special.</p>
                            </div>
                        </div>
                    </SwiperSlide>
