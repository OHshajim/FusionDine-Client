...
const Navbar = () => {
    ...
    return (
        <div>
            <div className={fix ? "navbar fixed z-10  duration-500 bg-black text-white" : "text-white navbar  duration-300 fixed z-10"} data-aos-duration="1000" data-aos="fade-down">
