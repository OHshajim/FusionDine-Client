    ...
    return (
        <div className="my-20 mx-auto max-w-[1600px] px-5">
            <div className="flex flex-col justify-center items-center">
                <h2 className="text-4xl mb-4">Our Experience Chefs</h2>
                        ...
                        <div className='flex  justify-center'>
                            <div className='relative group '>
                                ...
                                <div className='absolute rounded-md bottom-2 left-2 hover:border-4 group-hover:visible hover:border-orange-500 invisible p-5 bg-white text-black  hover:-translate-y-2 hover:translate-x-2 hover:duration-500'>
                                    <h3 className='text-xl font-bold'>Mr. Fahim</h3>
                    ...
                    <SwiperSlide>
                        <div className='flex  justify-center'>
                            <div className='relative group '>
                                ...
                                <div className='absolute rounded-md bottom-2 left-2 hover:border-4 group-hover:visible hover:border-orange-500 invisible p-5 bg-white text-black  hover:-translate-y-2 hover:translate-x-2 hover:duration-500'>
                                    <h3 className='text-xl font-bold'>Ms. ALex</h3>
                    ...
                    <SwiperSlide >
                        <div className='flex  justify-center'>
                            <div className='relative group '>
                                ...
                                <div className='absolute rounded-md bottom-2 left-2 hover:border-4 group-hover:visible hover:border-orange-500 invisible p-5 bg-white text-black  hover:-translate-y-2 hover:translate-x-2 hover:duration-500'>
                                    <h3 className='text-xl font-bold'>Mr. Sahariya</h3>
                    ...
                    <SwiperSlide >
                        <div className='flex  justify-center'>
                            <div className='relative group '>
                                ...
                                <div className='absolute rounded-md bottom-2 left-2 hover:border-4 group-hover:visible hover:border-orange-500 invisible p-5 bg-white text-black  hover:-translate-y-2 hover:translate-x-2 hover:duration-500'>
                                    <h3 className='text-xl font-bold'>Mr. Rasel</h3>
